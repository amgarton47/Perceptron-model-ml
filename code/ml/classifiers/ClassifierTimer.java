...
public class ClassifierTimer {
	 ...
	 * results just that the classify function gets called for all of the examples.
	 * 
	 * @param classifier
	 * @param dataset
	 */
	...
	public static void main(String[] args) {
		 ...
		 * didn't get your code working, come talk to me.
		 * 
		 * System.out.println("------------------------");
		 * System.out.println("Decision Tree:"); DecisionTreeClassifier dt = new
		 * DecisionTreeClassifier(); timeClassifier(dt, dataset, numRuns);
		 */
